...
<div class="block" id="app">
    <div class="block-content">
        <form action="{{ route('vista.gastos.store') }}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea name="informacion" id="" cols="30" rows="10" class="form-control" placeholder="Ingrese información del gasto hecho"></textarea>
                @error('informacion')
                    <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-alt-success">
                    <i class="fa fa-check"></i> Agregar gasto
                </button>    
            </div>
